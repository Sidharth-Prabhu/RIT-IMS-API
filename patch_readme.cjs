...
Submits the marked attendance for the students to the upstream portal. The exact payload depends on the upstream portal's required format.
...
content = content.replace('---', docsToInsert + '\n---');
