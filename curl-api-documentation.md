...
Set the following environment variables in your terminal, replacing `YOUR_APP_SUBDOMAIN` with your actual Netlify deployment domain:
```bash
...
# Config
# Replace with: https://YOUR_APP_SUBDOMAIN.netlify.app/ims
